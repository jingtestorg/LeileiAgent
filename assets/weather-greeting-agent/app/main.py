...
def main(host: str, port: int):
    skill = AgentSkill(
        id="weather-greeting-agent",
        name="weather-greeting-agent",
        description="An AI agent that greets users with personalized hello messages based on their location and current weather conditions",
        tags=["weather", "greeting", "agent"],
        examples=["Hello from Berlin!", "What's the weather like in Tokyo?"],
    )
